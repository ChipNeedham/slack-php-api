...
class UsergroupsEnable extends \JoliCode\Slack\Api\Runtime\Client\BaseEndpoint implements \JoliCode\Slack\Api\Runtime\Client\Endpoint
{
    /**
     * Enable a User Group
     *
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        return $serializer->deserialize($body, 'JoliCode\\Slack\\Api\\Model\\UsergroupsEnablePostResponsedefault', 'json');
    }
