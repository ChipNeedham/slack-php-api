...
class UsersListGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Slack\\Api\\Model\\UsersListGetResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('cache_ts', $data) && $data['cache_ts'] !== null) {
            $object->setCacheTs($data['cache_ts']);
        }
        elseif (\array_key_exists('cache_ts', $data) && $data['cache_ts'] === null) {
