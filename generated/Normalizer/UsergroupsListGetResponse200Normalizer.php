...
class UsergroupsListGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Slack\\Api\\Model\\UsergroupsListGetResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('usergroups', $data) && $data['usergroups'] !== null) {
            $values = array();
        ...
        elseif (\array_key_exists('usergroups', $data) && $data['usergroups'] === null) {
