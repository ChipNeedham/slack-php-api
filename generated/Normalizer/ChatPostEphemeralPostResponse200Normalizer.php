...
class ChatPostEphemeralPostResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Slack\\Api\\Model\\ChatPostEphemeralPostResponse200';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Slack\\Api\\Model\\ChatPostEphemeralPostResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('message_ts', $data) && $data['message_ts'] !== null) {
            $object->setMessageTs($data['message_ts']);
        }
        elseif (\array_key_exists('message_ts', $data) && $data['message_ts'] === null) {
