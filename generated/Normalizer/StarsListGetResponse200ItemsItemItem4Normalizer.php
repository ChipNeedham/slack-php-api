...
class StarsListGetResponse200ItemsItemItem4Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Slack\\Api\\Model\\StarsListGetResponse200ItemsItemItem4';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Slack\\Api\\Model\\StarsListGetResponse200ItemsItemItem4';
    }
    /**
     * @return mixed
     */
