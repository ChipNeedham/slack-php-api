...
class ConversationsLeavePostResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Slack\\Api\\Model\\ConversationsLeavePostResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('not_in_channel', $data) && $data['not_in_channel'] !== null) {
            $object->setNotInChannel($data['not_in_channel']);
        }
        elseif (\array_key_exists('not_in_channel', $data) && $data['not_in_channel'] === null) {
