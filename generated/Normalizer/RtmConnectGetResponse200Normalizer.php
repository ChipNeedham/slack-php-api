...
class RtmConnectGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Slack\\Api\\Model\\RtmConnectGetResponse200';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Slack\\Api\\Model\\RtmConnectGetResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('self', $data) && $data['self'] !== null) {
        ...
        elseif (\array_key_exists('self', $data) && $data['self'] === null) {
            $object->setSelf(null);
        }
