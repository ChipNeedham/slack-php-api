...
class ObjsMessageAttachmentsItemFieldsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Slack\\Api\\Model\\ObjsMessageAttachmentsItemFieldsItem';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('short', $data) && $data['short'] !== null) {
            $object->setShort($data['short']);
        }
        elseif (\array_key_exists('short', $data) && $data['short'] === null) {
