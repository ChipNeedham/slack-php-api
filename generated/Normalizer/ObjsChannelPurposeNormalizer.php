...
class ObjsChannelPurposeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Slack\\Api\\Model\\ObjsChannelPurpose';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Slack\\Api\\Model\\ObjsChannelPurpose';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('last_set', $data) && $data['last_set'] !== null) {
            $object->setLastSet($data['last_set']);
        }
        elseif (\array_key_exists('last_set', $data) && $data['last_set'] === null) {
